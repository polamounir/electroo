...
export default function ChatPopup() {
  ...
  return (
    <div
      ...
      } flex flex-col gap-10 items-center fixed border-2 border-gray-200 rounded-lg overflow-hidden shadow-lg shadow-teal-500 bottom-5 right-0 sm:right-5 z-[110] max-w-sm min-w-xs md:min-w-sm bg-white`}
    >
