          ...
          <div className="py-3 space-y-6">
            ...
            <div className="flex items-center justify-between cursor-pointer p-3 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors">
              <span className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-teal-500" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M5 2a2 2 0 00-2 2v14l3.5-2 3.5 2 3.5-2 3.5 2V4a2 2 0 00-2-2H5zm4.707 5.707a1 1 0 00-1.414-1.414l-3 3a1 1 0 000 1.414l3 3a1 1 0 001.414-1.414L8.414 10l1.293-1.293zm4 0a1 1 0 010 1.414L13.586 10l-1.293 1.293a1 1 0 01-1.414-1.414l3-3a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                التوفيرات
              </span>
            ...
            <div className="bg-gray-750 p-4 rounded-lg">
              ...
              <div className="flex justify-between text-sm text-gray-300 mt-4">
                <span className="bg-gray-700 px-3 py-1 rounded-full">{rangeValues[0]} ج م</span>
                <span className="bg-gray-700 px-3 py-1 rounded-full">{rangeValues[1]} ج م</span>
              </div>
            </div>
          </div>
        )}
