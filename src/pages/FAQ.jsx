...
export default function FAQ() {
  ...
  const faqItems = [
    ...
    {
      id: 2,
      question: "كيف يمكنني التسجيل كتاجر أو تاجر في المنصة؟",
      answer:
        'ببساطة عليك النقر على زر "إنشاء حساب"، واختيار نوع الحساب (تاجر أو تاجر)، ثم تعبئة النموذج وتقديم جميع البيانات المطلوبة ثم متابعة الخطوات التي تظهر لك لتفعيل حسابك.',
    },
    {
      id: 3,
  ...
  return (
    <div className="pt-30 pb-20 px-4 md:px-10 lg:px-20  mx-auto min-h-[90svh]">
